...
form.addEventListener("submit",(e)=>{
  ...
  //nombre
    if(flgNom==false){
      ...
      document.getElementById("nombre").innerHTML="❌El campo esta vacio o tiene caracteres especiales y numeros,Ingrese un nombre correcto.";
    }else if(flgNom==true){
    ...
    if(flgCel==false){
      ...
      document.getElementById("celular").innerHTML="❌El campo esta vacio o tiene mas de 9 digitos,Ingrese un numero de celular correcto.";
    ...
    if(flgCorreo==false){
      ...
      document.getElementById("email").innerHTML="❌El campo esta vacio o no contiene el dominio de correo, Ingrese un correo electronico correcto.";
...
//mensaje
     if(mensaje.value.length==0 || mensaje.value.length>500){
      ...
      document.getElementById("mensaje").innerHTML="❌El campo esta vacio o ha ingresado mas de 500 caracteres. Ingrese 500 caracteres como maximo.";
